...
# Vendored from Depth-Anything-3
# (Depth-Anything-3/src/depth_anything_3/model/dpt.py).
# Apache-2.0 license, original copyright (c) 2025 ByteDance Ltd.
#
# Verbatim copy except: helper imports redirected to the local `dpt_utils`
# module so this DPT is self-contained inside the EoMT package. Used as
# the monocular depth head per DA3's `da3mono-large` recipe.
from models.dpt_utils import (
    Permute,
    create_uv_grid,
    custom_interpolate,
